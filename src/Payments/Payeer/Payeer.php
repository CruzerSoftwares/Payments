...
namespace Cruzer\Payments\Payeer;

use Cruzer\Payments\Payeer\CoinpaymentsCurlRequest;

/**
 * Payeer.net PHP API Wrapper
 *
 * @link https://www.coinpayments.net/apidoc Official Payeer.net API Documentation.
 * @copyright (c) 2018, Payeer.net
 *
 ...
 * non-testing currency and are excluded from the capabilities of LTCT in the Payeer API.
 *
 * $PayByName tag commands also rely on having available or claimed tags on the production Payeer.net website to
 * manipulate.
 */
class Payeer
{
     ...
     * an IPN when complete. If you are sending to another Payeer user and you have their $PayByName tag or
     ...
     * @param string $address The address to send funds to. If blank or not included the coins will go to your Payeer Wallet.
